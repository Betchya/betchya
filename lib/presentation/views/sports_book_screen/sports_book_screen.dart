        ...
        body: NestedScrollView(
          ...
          body: Query(
            options: QueryOptions(
                document: gql(mlbQuery),
                variables: const <String, dynamic>{'x-api-key': 'da2-lg6tat5g4zaxjc2evzkbytw2oe'}),
            builder: (result, {fetchMore, refetch}) { 

              final items = result.data?['listMLBBettingEvents']['items'][0];
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Text(
                          '${items["Name"]} \nGame Start: ${items["GameStartTime"]}',
