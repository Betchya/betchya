...
class Game {
  ...
  factory Game.fromJson(Map<String, dynamic> json) => Game(
    ...
    date: json['DateTime'] != null ? _formatDateTime(json['DateTime'] as String) : null,
...
String _formatDateTime(String dateTimeString) {
  ...
  // Format the date
  final formattedDate = DateFormat('E h:mma z').format(dateTime);
  
  // Replace 'PM' with 'pm' to match your desired format
  return formattedDate.replaceFirst('PM', 'pm');;
}
